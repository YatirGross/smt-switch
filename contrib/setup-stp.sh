...
if [ -f "$DEPS/stp/build/lib/libstp.a" ] || [ -f "$DEPS/stp/build/lib/libstp.so" ]; then
    ...
    echo -e "\033[1;33m|  IMPORTANT: Library Path Setup      |\033[0m"
    echo -e "\033[1;33m========================================\033[0m"
    echo -e "\033[1;32mTo run tests, export the library path:\033[0m"
    echo -e "\033[1;36mexport LD_LIBRARY_PATH=\"$DEPS/stp/deps/install/lib:\$LD_LIBRARY_PATH\"\033[0m"
    echo -e "\033[1;33m========================================\033[0m"
    echo ""
else
